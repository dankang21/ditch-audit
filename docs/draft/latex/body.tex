...
S2 & That ground is an agent with intentions and will & Leslie's axiarchism; Tegmark 2008 & pro: Swinburne 2004 $\cdot$ contra: Morriston 2000 & contested; only observational channel routes through S5 & $\alpha$ \\
...
family-correlation watch (\S{}6.3) read P(B = C \textbar{} A $\neq$ B) between .41 and .52 on all dimensions,
...
The multiplicative structure of (1) is not news to the literature; it is the engine of the dwindling-probabilities exchange. Plantinga (\emph{Warranted Christian Belief}, 2000) argued that the probability of full Christian belief, propagated through a chain of stages on historical evidence, dwindles multiplicatively to unimpressive values. Swinburne's reply (\emph{Faith and Philosophy}, 2004) charged the argument with mishandling how evidence enters at each stage; T. McGrew (\emph{Philosophia Christi}, 2004) pressed a structurally similar objection; Plantinga replied in 2004 --- with, as reported in the secondary literature, a partial concession {[}verify against the primary text before submission, per the project's must-verify register{]} --- followed by McGrew and McGrew (\emph{Philosophia Christi} 8(1), 2006) and, later, Nickel (De Gruyter, 2015).
