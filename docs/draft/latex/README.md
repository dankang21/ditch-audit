# LaTeX package — preprint (draft v0.8, 2026-07-20)
...
- abstract.tex    — abstract (generated from docs/draft/draft-v0.md, v0.8)
- front.tex       — keywords + "How to read this document" (v0.8)
...
Generated from draft-v0.md (v0.8); companion essay: docs/draft/essay-checkpoint.md.
